...
export function JoiningScreen({
  ...
  return (
    <div className="fixed inset-0">
      <div className="overflow-y-auto flex flex-col flex-1 h-screen bg-gradient-to-r from-blue-100 via-gray-100   to-blue-100">
                ...
                <div className="flex items-center justify-center p-1.5 sm:p-4 lg:p-6">
                  <div className="relative w-full md:pl-4 sm:pl-10 pl-5  md:pr-4 sm:pr-10 pr-5">
                    ...
                    {!isMobile &&
                      meetingMode === Constants.modes.CONFERENCE && (
                        <div
                          className="m-4 absolute md:left-12 lg:left-24 xl:left-44 md:right-12 lg:right-24 xl:right-44 rounded cursor-pointer"
                          onClick={(e) => {
                            handleClickOpen();
                          }}
                        >
